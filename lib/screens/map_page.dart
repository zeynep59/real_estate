    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          SlidingUpPanel(
            ...
            onPanelClosed: () {
              setState(() {
                _showFavorites = false; // Ensure the flag is reset when the panel is closed
              });
            },
          ),
        ],
      ...
      bottomNavigationBar: GNav(
        ...
        onTabChange: (index) {
          setState(() {
            if (index == 0) {
              _showFavorites = false; // Hide favorites panel when Home tab is selected
            } else if (index == 1) {
              Navigator.pushNamed(context, '/professionels');
            } else if (index == 2) {
              _showFavorites = true; // Show favorites panel when Favorites tab is selected
            } else if (index == 3) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: OutlinedButton( // Buton şeklinde düğme
                  onPressed: () {
                    // Butona basıldığında yapılacak işlemler buraya gelecek
                  },
                  style: OutlinedButton.styleFrom(
                    backgroundColor: Colors.grey[200], // Butonun arka plan rengi
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8.0), // Butonun kenarlarını yuvarlayalım
                    ),
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Column( // Satır yerine sütun kullanarak alt alta yazıları yerleştirelim
                      ...
                      children: [
                        ...
                        SizedBox(height: 8), // Yazılar arasına biraz boşluk ekleyelim
